...
class Settings {
    public function __construct() {
        ...
        $this->avatar_source = 'https://cravatar.eu/helmavatar/{uuid}/25';
        ...
        $this->avatar_source_offline_mode = 'https://minotar.net/helm/{name}/25';
